...
.\end{eqnarray}
Obviously, we can choose $i$ such that it attains the maximum from \eref{infty-norm-Av-div-norm-v}, which proves our claim that $||A||_{\infty}$ is the maximum absolute row sum of $A$.
...
The code and output is shown in the screenshot below:
\begin{center}
